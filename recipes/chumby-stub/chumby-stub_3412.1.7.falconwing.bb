...
SRC_URI = "${CHUMBYSG_GIT_HOST}/chumby-private/https_internal.chumby.com_firmware_bootstream-1.0_${RVERSION}${CHUMBYSG_GIT_EXTENSION};subpath=src;protocol=${CHUMBYSG_GIT_PROTOCOL}"
SRCREV = "${AUTOREV}"
